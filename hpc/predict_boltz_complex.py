"""external HPC-side Boltz-2 COMPLEX refold runner (M6c-lite, binder/interface de-risk).
...
RUNS ON EXTERNAL HPC (GPU). `boltz` conda env + PYTHONNOUSERSITE=1 + `--no_kernels`. See run_predict_boltz_complex.sbatch.
"""
