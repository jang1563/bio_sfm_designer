"""external HPC-side Boltz-2 INDEPENDENT refold runner (M6a).
...
RUNS ON EXTERNAL HPC (GPU). Needs the `boltz` conda env + PYTHONNOUSERSITE=1 (so ~/.local doesn't shadow the
