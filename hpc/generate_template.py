"""Cayuga-side generative SFM runner TEMPLATE.
...
RUNS ON CAYUGA/EXPANSE (GPU) inside the generator's conda env. The local PrecomputedGenerator
...
def main() -> None:
    ap = argparse.ArgumentParser(description="Cayuga generative-SFM runner (template)")
