...
(complex_plddt/ptm), and the record schema. Boltz inference itself is verified on external HPC.
"""
...
class PredictBoltzContractTests(unittest.TestCase):
    @unittest.skipUnless(_HAS_NUMPY, "numpy needed for the Kabsch scRMSD (verified on external HPC)")
