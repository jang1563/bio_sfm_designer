"""Simulate the Cayuga DeBERTa producer locally to prove the producer->consumer JSONL
...
class ScreenContractTests(unittest.TestCase):
    ...
    def test_producer_output_feeds_consumer(self):
        ...
        with tempfile.TemporaryDirectory() as d:
            ...
            # run the Cayuga producer (with the fake guard) exactly as the sbatch would
            argv = sys.argv
