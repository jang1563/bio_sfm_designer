...
- W2_panel_submission_decision: status=`awaiting_explicit_panel_submission_approval` no_submit=`True` submitted=`False` can_claim_w2_generalization=`False` operator_checklist_ok=`True`
