...
> hashes and exact-bound bottleneck are in `docs/M6D_W2B_FIT_COMPLETION.md`. The separately approved
> certification stage completed with 300 fresh H100 records and strict QC failures=0. `1F93_DC`,
> `1FDH_GA`, `1FLT_WV`, and `1FVC_DC` certified under `trust_all`. The sole selective target `1F51_AE`
> failed exact certification with 31 accepts, 6 false accepts, and UCB 0.4002. Its fresh diagnostic pAE
> AUROC remains 0.7839 but does not affect the certificate. Because the locked panel requires one selective
...
> and 24 prospective cells. Current additional predictor, H100, ProteinMPNN, MSA-query, and API authority
> is zero.
...
bundle preserves no-submit, claim-boundary, and tracked postsubmit script-chain checks; it also records
...
7. **P0 credential hygiene:** JK attested completion on 2026-07-23 and authorized one Anthropic
   `claude-opus-4-8` shadow call. The bounded result is
   `docs/LLM_ORCHESTRATION_LIVE_SMOKE_2026_07_23.md`: transport passed, semantic authority failed, and
