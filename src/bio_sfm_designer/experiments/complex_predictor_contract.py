...
def render_sync_back_plan(report: Dict[str, Any], *,
    ...
    lines = [
        ...
        "# Pull missing/empty secondary-predictor JSONL artifacts from external HPC.",
        "set -euo pipefail",
        "",
        _shell_assignment(
            "REMOTE_ROOT",
...
def main(argv=None) -> Dict[str, Any]:
    ...
    ap.add_argument("--emit-sync-back-plan", default=None,
                    help="optional shell plan to rsync missing secondary-predictor records back from external HPC")
