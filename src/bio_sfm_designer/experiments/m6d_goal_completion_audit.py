...
def _operator_approval_checklist_state(checklist: Any) -> Dict[str, Any]:
    ...
    checks = {
        ...
        "postsubmit_driver_static_chain_ok": checklist.get("postsubmit_driver_static_chain_ok") is True,
        "postsync_replay_static_chain_ok": checklist.get("postsync_replay_static_chain_ok") is True,
        "sync_back_static_chain_ok": checklist.get("sync_back_static_chain_ok") is True,
        "completion_static_chain_ok": checklist.get("completion_static_chain_ok") is True,
        "script_chain_static_ok": checklist.get("script_chain_static_ok") is True,
    ...
    return {
        ...
        "postsubmit_driver_static_chain_ok": checklist.get("postsubmit_driver_static_chain_ok"),
        "postsync_replay_static_chain_ok": checklist.get("postsync_replay_static_chain_ok"),
        "sync_back_static_chain_ok": checklist.get("sync_back_static_chain_ok"),
        "completion_static_chain_ok": checklist.get("completion_static_chain_ok"),
        "script_chain_static_ok": checklist.get("script_chain_static_ok"),
...
def _panel_submission_decision_state(panel_submission_decision_state: Optional[Dict[str, Any]]) -> Dict[str, Any]:
    ...
    return {
        ...
        "operator_postsubmit_driver_static_chain_ok": operator.get("postsubmit_driver_static_chain_ok"),
        "operator_postsync_replay_static_chain_ok": operator.get("postsync_replay_static_chain_ok"),
        "operator_sync_back_static_chain_ok": operator.get("sync_back_static_chain_ok"),
        "operator_completion_static_chain_ok": operator.get("completion_static_chain_ok"),
...
def build_audit(project_status: Dict[str, Any],
    ...
    return {
        ...
        "w2_gate": {
            ...
            "panel_submission_decision_operator_script_chain_static_ok": panel_submission_decision.get(
...
def render_markdown(rep: Dict[str, Any]) -> str:
    ...
    lines.extend([
        ...
        f"- W2 panel submission decision operator script chain static ok: `{rep.get('w2_gate', {}).get('panel_submission_decision_operator_script_chain_static_ok')}`",
