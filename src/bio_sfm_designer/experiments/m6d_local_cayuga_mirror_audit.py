...
_JSON_FIELD_SPECS: Dict[str, List[str]] = {
    ...
    "results/m6d_w2_target_family_redesign_v11_public_approval_bundle.json": [
        ...
        "pre_submit_approval_intent_audit.command_expected",
        "pre_submit_approval_intent_audit.requires_accepted",
        "pre_submit_approval_intent_audit.no_submit",
        "pre_submit_approval_intent_audit.submitted",
    ...
    "results/m6d_w2_target_family_redesign_v11_submission_decision_state.json": [
        ...
        "operator_approval_checklist.approval_intent_audit_command",
        ...
        "operator_approval_checklist.postsubmit_driver_static_chain_ok",
        "operator_approval_checklist.postsync_replay_static_chain_ok",
        "operator_approval_checklist.sync_back_static_chain_ok",
        "operator_approval_checklist.completion_static_chain_ok",
        "operator_approval_checklist.script_chain_static_ok",
